...
import com.example.adoptify_core.databinding.ActivityReviewFormUserBinding
import com.google.android.material.tabs.TabLayout
import com.google.android.material.tabs.TabLayoutMediator

class ReviewFormUserActivity : BaseActivity() {

    private lateinit var binding: ActivityReviewFormUserBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityReviewFormUserBinding.inflate(layoutInflater)
    ...
    private fun setupView() {
        binding.apply {
            ...
            val reviewAdapter = ReviewFormUserAdapter(this@ReviewFormUserActivity, reqId!!, category!!)
