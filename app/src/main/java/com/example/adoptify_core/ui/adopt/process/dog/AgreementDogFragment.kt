...
import com.example.adoptify_core.databinding.FragmentAgreementDogBinding
import com.example.adoptify_core.ui.adopt.process.cat.CustomTypefaceSpan
...
class AgreementDogFragment : Fragment() {

    private var _agreementDog: FragmentAgreementDogBinding? = null

    private val agreementDog get() = _agreementDog!!
    ...
    override fun onCreateView(
        ...
        _agreementDog = FragmentAgreementDogBinding.inflate(inflater, container, false)
        return _agreementDog?.root
    }
    ...
    private fun setupListener() {
        agreementDog.apply {
            switchButton.setOnCheckedChangeListener { _, isChecked ->
                ...
                btnNext.setTextColor(if (isChecked) resources.getColor(R.color.white) else resources.getColor(
                    R.color.black))
            }
            ...
            btnNext.setTextColor(if (isButtonEnable) resources.getColor(R.color.white) else resources.getColor(
                R.color.black))
    ...
    private fun setupView() {
        ...
        agreementDog.cardAgreement.txtTerms.text = spannableString
    }
